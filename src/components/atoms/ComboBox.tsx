...
export function ComboBox<V, M extends boolean = false>({
    ...
    return (
        <div className="relative w-full">
            {label && (
                <span className="block text-sm font-medium text-textGray">
                    {label}
                </span>
            )}
            <div 
                            ...
                            <ul
                                ...
                                style={{
                                    top: inputPosition
                                      ...
                                      : 0,
                                    left: inputPosition ? inputPosition.left : 0,
                                ...
                                <li className="flex items-center bg-selected-background p-2 sticky top-0">
                                    ...
                                    <div className={twMerge("rounded-lg cursor-pointer dark:bg-dark-gray flex-1", (multiple && isArray(value)) ? "ml-4" : "")}>
                                        <InputText 
                                            ...
                                            placeholder={placeholder}
                                            className={twMerge(
                                                "flex-grow outline-none flex-1 dark:bg-black bg-background dark:text-white w-full"
                                            )}
